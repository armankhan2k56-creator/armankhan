...
def old_Tow():
    ____banner____()
    print("       \x1b[38;5;49mOld Code Series 2 (100003/4)\033[0m")
    linex()
    time.sleep(2)
    BNG_71_()
...
def old_Tree():
    ____banner____()
    print("       \x1b[38;5;49mOld Code Series 3 (2009)\033[0m")
    linex()
    time.sleep(2)
    BNG_71_()
...
if __name__ == '__main__':
    ...
    time_left = calculate_time_left(expiry_date) if 'calculate_time_left' in globals() else expiry_date
